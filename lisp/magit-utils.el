...
;; `completion-pcm--all-completions' reverses the completion list.
;; We'll will temporarily override it with the function below to
;; preserve the order of our pre-sorted completions.  bug#24676
